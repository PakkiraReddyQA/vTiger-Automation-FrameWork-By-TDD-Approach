...
public class CreateOrganizationWithDDT {
	...
	public void ddt() throws Exception {
		...
		FileInputStream foie=new FileInputStream(".\\src\\test\\resources\\TestData.xlsx");
		 ...
		 wUtil.takescreenshot(driver, "LoginPageSC"+jUtil.getSystemDateformat());
		 Thread.sleep(1000);
		 ...
		 Thread.sleep(1000);
		 wUtil.takescreenshot(driver, "HomePageSC"+jUtil.getSystemDateformat());
		 //step4:click on organization link
		 driver.findElement(By.linkText("Organizations")).click();
		 
		 Thread.sleep(1000);
		 wUtil.takescreenshot(driver, "OrgLkpPage"+jUtil.getSystemDateformat());
		 ...
		 Thread.sleep(1000);
		 wUtil.takescreenshot(driver, "OrgFormPage"+jUtil.getSystemDateformat());
		 //step6:save
